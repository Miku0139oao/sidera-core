...
// 	protoc        v6.31.1
// source: experimental/v2rayapi/stats.proto
...
func (x *TrafficUserStat) Reset() {
	*x = TrafficUserStat{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrafficUserStat) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{7}
}
...
func (x *UserStat) Reset() {
	*x = UserStat{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserStat) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{8}
}
...
func (x *GetUsersStatsRequest) Reset() {
	*x = GetUsersStatsRequest{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUsersStatsRequest) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{9}
}
...
func (x *GetUsersStatsResponse) Reset() {
	*x = GetUsersStatsResponse{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUsersStatsResponse) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{10}
}
...
func (x *QueryStatsRequest) Reset() {
	*x = QueryStatsRequest{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*QueryStatsRequest) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{11}
}
...
func (x *QueryStatsResponse) Reset() {
	*x = QueryStatsResponse{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*QueryStatsResponse) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{12}
}
...
func (x *SysStatsRequest) Reset() {
	*x = SysStatsRequest{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SysStatsRequest) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{13}
}
...
func (x *SysStatsResponse) Reset() {
	*x = SysStatsResponse{}
	mi := &file_experimental_v2rayapi_stats_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SysStatsResponse) Descriptor() ([]byte, []int) {
	return file_experimental_v2rayapi_stats_proto_rawDescGZIP(), []int{14}
}
...
const file_experimental_v2rayapi_stats_proto_rawDesc = "" +
	"\n" +
	"!experimental/v2rayapi/stats.proto\x12\x16xray.app.stats.command\";\n" +
	...
	"\x04stat\x18\x01 \x01(\v2\x1c.xray.app.stats.command.StatR\x04stat\"\xbb\x01\n" +
	...
	"\x05users\x18\x01 \x03(\v2 .xray.app.stats.command.UserStatR\x05users\"w\n" +
	...
	"\rGetUsersStats\x12,.xray.app.stats.command.GetUsersStatsRequest\x1a-.xray.app.stats.command.GetUsersStatsResponse\"\x00B:Z8github.com/Miku0139oao/sidera-core/experimental/v2rayapib\x06proto3"
...
var file_experimental_v2rayapi_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_experimental_v2rayapi_stats_proto_goTypes = []any{
	...
	(*GetStatsOnlineIpListResponse)(nil), // 3: xray.app.stats.command.GetStatsOnlineIpListResponse
	(*GetAllOnlineUsersRequest)(nil),     // 4: xray.app.stats.command.GetAllOnlineUsersRequest
	(*GetAllOnlineUsersResponse)(nil),    // 5: xray.app.stats.command.GetAllOnlineUsersResponse
	(*OnlineIPEntry)(nil),                // 6: xray.app.stats.command.OnlineIPEntry
	(*TrafficUserStat)(nil),              // 7: xray.app.stats.command.TrafficUserStat
	(*UserStat)(nil),                     // 8: xray.app.stats.command.UserStat
	(*GetUsersStatsRequest)(nil),         // 9: xray.app.stats.command.GetUsersStatsRequest
	(*GetUsersStatsResponse)(nil),        // 10: xray.app.stats.command.GetUsersStatsResponse
	(*QueryStatsRequest)(nil),            // 11: xray.app.stats.command.QueryStatsRequest
	(*QueryStatsResponse)(nil),           // 12: xray.app.stats.command.QueryStatsResponse
	(*SysStatsRequest)(nil),              // 13: xray.app.stats.command.SysStatsRequest
	(*SysStatsResponse)(nil),             // 14: xray.app.stats.command.SysStatsResponse
	nil,                                  // 15: xray.app.stats.command.GetStatsOnlineIpListResponse.IpsEntry
}
var file_experimental_v2rayapi_stats_proto_depIdxs = []int32{
	...
	15, // 1: xray.app.stats.command.GetStatsOnlineIpListResponse.ips:type_name -> xray.app.stats.command.GetStatsOnlineIpListResponse.IpsEntry
	6,  // 2: xray.app.stats.command.UserStat.ips:type_name -> xray.app.stats.command.OnlineIPEntry
	7,  // 3: xray.app.stats.command.UserStat.traffic:type_name -> xray.app.stats.command.TrafficUserStat
	8,  // 4: xray.app.stats.command.GetUsersStatsResponse.users:type_name -> xray.app.stats.command.UserStat
	1,  // 5: xray.app.stats.command.QueryStatsResponse.stat:type_name -> xray.app.stats.command.Stat
	...
	11, // 8: xray.app.stats.command.StatsService.QueryStats:input_type -> xray.app.stats.command.QueryStatsRequest
	13, // 9: xray.app.stats.command.StatsService.GetSysStats:input_type -> xray.app.stats.command.SysStatsRequest
	0,  // 10: xray.app.stats.command.StatsService.GetStatsOnlineIpList:input_type -> xray.app.stats.command.GetStatsRequest
	4,  // 11: xray.app.stats.command.StatsService.GetAllOnlineUsers:input_type -> xray.app.stats.command.GetAllOnlineUsersRequest
	9,  // 12: xray.app.stats.command.StatsService.GetUsersStats:input_type -> xray.app.stats.command.GetUsersStatsRequest
	...
	12, // 15: xray.app.stats.command.StatsService.QueryStats:output_type -> xray.app.stats.command.QueryStatsResponse
	14, // 16: xray.app.stats.command.StatsService.GetSysStats:output_type -> xray.app.stats.command.SysStatsResponse
	3,  // 17: xray.app.stats.command.StatsService.GetStatsOnlineIpList:output_type -> xray.app.stats.command.GetStatsOnlineIpListResponse
	5,  // 18: xray.app.stats.command.StatsService.GetAllOnlineUsers:output_type -> xray.app.stats.command.GetAllOnlineUsersResponse
	10, // 19: xray.app.stats.command.StatsService.GetUsersStats:output_type -> xray.app.stats.command.GetUsersStatsResponse
