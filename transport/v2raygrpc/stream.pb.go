...
const file_transport_v2raygrpc_stream_proto_rawDesc = "" +
	...
	"\n" +
	"GunService\x12?\n" +
	"\x03Tun\x12\x19.transport.v2raygrpc.Hunk\x1a\x19.transport.v2raygrpc.Hunk(\x010\x01B8Z6github.com/Miku0139oao/sidera-core/transport/v2raygrpcb\x06proto3"
